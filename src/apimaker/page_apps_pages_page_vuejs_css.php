...
.block_content{ padding:5px; min-height:100px;resize:auto; margin-bottom:20px; border:1px solid #aaa; }
.block_editor_div{ position:relative; height:100px; line-height:20px; font-size:1rem; }
...
.comp_content{ padding:10px; background-color:white; border:1px solid #ccc; font-size:1rem; }
...
.structure_editor_div{ position:relative; height:100px; line-height:20px; font-size:1rem; }
